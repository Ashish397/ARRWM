...
# kernel path: /scratch/u6ex/as1748.u6ex/ARRWM/.tmp/5317666/inductor/h5/ch5dink3ckcmzd3z4uvclizophnahvh3zkuw4impuofwe75sgdcx.py
# Topologically Sorted Source Nodes: [flex_attention], Original ATen: [flex_attention]
# Source node to ATen node mapping:
#   flex_attention => flex_attention
# Graph fragment:
#   %arg0_1 : Tensor "bf16[1, 12, 37504, 128][57606144, 128, 1536, 1]cuda:0" = PlaceHolder[target=arg0_1]
#   %arg1_1 : Tensor "bf16[1, 12, 37504, 128][57606144, 128, 1536, 1]cuda:0" = PlaceHolder[target=arg1_1]
#   %arg2_1 : Tensor "bf16[1, 12, 37504, 128][57606144, 128, 1536, 1]cuda:0" = PlaceHolder[target=arg2_1]
#   %buf0 : Tensor "f32[1, 12, 37504][450048, 37504, 1]cuda:0" = PlaceHolder[target=buf0]
#   %buf1 : Tensor "f32[1, 12, 37504][450048, 37504, 1]cuda:0" = PlaceHolder[target=buf1]
#   %arg4_1 : Tensor "i32[1, 1, 293][293, 293, 1]cuda:0" = PlaceHolder[target=arg4_1]
#   %arg3_1 : Tensor "i32[1, 1, 293, 293][85849, 85849, 293, 1]cuda:0" = PlaceHolder[target=arg3_1]
#   %arg10_1 : Tensor "i32[1, 1, 293][293, 293, 1]cuda:0" = PlaceHolder[target=arg10_1]
#   %arg11_1 : Tensor "i32[1, 1, 293, 293][85849, 85849, 293, 1]cuda:0" = PlaceHolder[target=arg11_1]
#   %arg5_1 : Tensor "i64[37504][1]cuda:0" = PlaceHolder[target=arg5_1]
#   %arg6_1 : Tensor "i64[37504][1]cuda:0" = PlaceHolder[target=arg6_1]
#   %arg7_1 : Tensor "i64[37504][1]cuda:0" = PlaceHolder[target=arg7_1]
#   %arg8_1 : Tensor "i64[37504][1]cuda:0" = PlaceHolder[target=arg8_1]
#   %arg9_1 : Tensor "i64[37504][1]cuda:0" = PlaceHolder[target=arg9_1]
#   %flex_attention : [num_users=1] = call_function[target=torch.ops.higher_order.flex_attention](args = (%arg0_1, %arg1_1, %arg2_1, %sdpa_score0, (37504, 37504, %arg4_1, %arg3_1, %arg10_1, %arg11_1, %arg12_1, %arg13_1, %arg14_1, %arg15_1, 128, 128, %sdpa_mask0), 0.08838834764831843, {BACKEND: AUTO, PRESCALE_QK: False, ROWS_GUARANTEED_SAFE: False, BLOCKS_ARE_CONTIGUOUS: False, WRITE_DQ: True, OUTPUT_LOGSUMEXP: False, OUTPUT_MAX: False}, (), (%arg5_1, %arg6_1, %arg7_1, %arg8_1, %arg9_1)), kwargs = {})
#   return %getitem
triton_tem_fused_flex_attention_0 = async_compile.triton('triton_tem_fused_flex_attention_0', '''
import triton
import triton.language as tl
...
class Runner:
    ...
    def call(self, args):
        ...
        args.clear()
        assert_size_stride(arg0_1, (1, 12, 37504, 128), (57606144, 128, 1536, 1))
        assert_size_stride(arg1_1, (1, 12, 37504, 128), (57606144, 128, 1536, 1))
        assert_size_stride(arg2_1, (1, 12, 37504, 128), (57606144, 128, 1536, 1))
        assert_size_stride(arg3_1, (1, 1, 293, 293), (85849, 85849, 293, 1))
        assert_size_stride(arg4_1, (1, 1, 293), (293, 293, 1))
        assert_size_stride(arg5_1, (37504, ), (1, ))
        assert_size_stride(arg6_1, (37504, ), (1, ))
        assert_size_stride(arg7_1, (37504, ), (1, ))
        assert_size_stride(arg8_1, (37504, ), (1, ))
        assert_size_stride(arg9_1, (37504, ), (1, ))
        assert_size_stride(arg10_1, (1, 1, 293), (293, 293, 1))
        assert_size_stride(arg11_1, (1, 1, 293, 293), (85849, 85849, 293, 1))
        assert_size_stride(arg12_1, (1, 1, 293), (293, 293, 1))
        assert_size_stride(arg13_1, (1, 1, 293, 293), (85849, 85849, 293, 1))
        assert_size_stride(arg14_1, (1, 1, 293), (293, 293, 1))
        assert_size_stride(arg15_1, (1, 1, 293, 293), (85849, 85849, 293, 1))
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            buf0 = empty_strided_cuda((1, 12, 37504), (450048, 37504, 1), torch.float32)
            buf1 = empty_strided_cuda((1, 12, 37504), (450048, 37504, 1), torch.float32)
            buf2 = empty_strided_cuda((1, 12, 37504, 128), (57606144, 128, 1536, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [flex_attention], Original ATen: [flex_attention]
            stream0 = get_raw_stream(0)
            triton_tem_fused_flex_attention_0.run(arg0_1, arg1_1, arg2_1, buf0, buf1, arg4_1, arg3_1, arg10_1, arg11_1, arg5_1, arg6_1, arg7_1, arg8_1, arg9_1, buf2, 586, 1, 12, stream=stream0)
            del arg0_1
            del arg10_1
            del arg11_1
            del arg1_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((1, 12, 37504, 128), (57606144, 128, 1536, 1), device='cuda:0', dtype=torch.bfloat16)
    arg1_1 = rand_strided((1, 12, 37504, 128), (57606144, 128, 1536, 1), device='cuda:0', dtype=torch.bfloat16)
    arg2_1 = rand_strided((1, 12, 37504, 128), (57606144, 128, 1536, 1), device='cuda:0', dtype=torch.bfloat16)
    arg3_1 = rand_strided((1, 1, 293, 293), (85849, 85849, 293, 1), device='cuda:0', dtype=torch.int32)
    arg4_1 = rand_strided((1, 1, 293), (293, 293, 1), device='cuda:0', dtype=torch.int32)
    arg5_1 = rand_strided((37504, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg6_1 = rand_strided((37504, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg7_1 = rand_strided((37504, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg8_1 = rand_strided((37504, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg9_1 = rand_strided((37504, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg10_1 = rand_strided((1, 1, 293), (293, 293, 1), device='cuda:0', dtype=torch.int32)
    arg11_1 = rand_strided((1, 1, 293, 293), (85849, 85849, 293, 1), device='cuda:0', dtype=torch.int32)
    arg12_1 = rand_strided((1, 1, 293), (293, 293, 1), device='cuda:0', dtype=torch.int32)
    arg13_1 = rand_strided((1, 1, 293, 293), (85849, 85849, 293, 1), device='cuda:0', dtype=torch.int32)
    arg14_1 = rand_strided((1, 1, 293), (293, 293, 1), device='cuda:0', dtype=torch.int32)
    arg15_1 = rand_strided((1, 1, 293, 293), (85849, 85849, 293, 1), device='cuda:0', dtype=torch.int32)
