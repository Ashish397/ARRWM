...
ARR = os.environ.get("AF_ROOT", os.path.dirname(os.path.abspath(__file__)))
...
OUT = os.environ.get("GL_OUT", os.path.join(os.environ.get("DATA_ROOT", ""), "frodobots_lmdb/v14e"))
...
def main():
    ...
    z_ds = ZarrRideDataset.from_manifest(
        ...
        motion_root=str(cfg.get("motion_root", os.path.join(os.environ.get("DATA_ROOT", ""), "frodobots_motion"))),
