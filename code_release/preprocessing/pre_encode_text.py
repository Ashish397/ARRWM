...
DEFAULT_NEGATIVE_ROOT = Path(os.path.join(os.environ.get("DATA_ROOT", ""), "frodobots_captions/negative"))
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--source-dir",
        type=Path,
        default=Path(os.path.join(os.environ.get("DATA_ROOT", ""), "frodobots_captions")),
