...
Writes out/stationary_cotracker_pca_nullinv.csv and out/stationary_signs_nullinv.csv.
"""
import os, sys, glob
...
WORK = f"{ARR}/stationary_eval_nullinv"
...
def main():
    pca_csv = run("stationary_cotracker_pca", "stationary_cotracker_pca_nullinv.csv")
    sgn_csv = run("stationary_signs", "stationary_signs_nullinv.csv")
