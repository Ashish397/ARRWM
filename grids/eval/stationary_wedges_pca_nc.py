...
OUT = os.path.join(HERE, "out", "stationary_wedges_pca_nc.png")
d = pd.read_csv(os.path.join(HERE, "out", "stationary_cotracker_pca_nullinv.csv"))

disp = {"pca8": "Default", "pca4": "pca4", "pca2": "pca2", "16node": "Batch64",
        "4node": "Batch16", "noatok": "No Action Tokens", "noadaln": "No AdaLN", "nocritic": "No Critic",
...
order = ["pca4", "4node", "noatok", "pca2", "16node", "pca8", "noadaln",
         "nocritic", "minwm", "matrixgame", "worldplay", "worldcam", "yume", "astra"]
