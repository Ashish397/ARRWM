...
srun --jobid=$HOLDER --overlap --nodelist=nid010280 --nodes=1 --ntasks-per-node=1 --gpus-per-node=4 --gpu-bind=none --export=ALL,CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun \
  --nnodes=1 \
  --nproc_per_node=4 \
