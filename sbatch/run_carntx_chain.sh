...
# forward_noiser_chain_levels=true => FN(student chunk @L) -> clean GT
...
export PORTOFF=${PORTOFF:-9977}
export RUNSTAMP=${RUNSTAMP:-$(date +%H%M%S)}
export DARM=carntx_chain
