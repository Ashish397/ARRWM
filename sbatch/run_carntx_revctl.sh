#!/bin/bash
# CARN REVERSE TEST — CONTROL. Same ganv2f_all_fnoiser recipe with the FN
# fully OFF (forward_noiser_enabled=false); GAN + seam + everything else
# identical. Difference vs arm = the reverse-FN treatment only.
