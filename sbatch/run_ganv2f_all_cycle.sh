#!/bin/bash
# ganv2f_all_cycle — ALL fixes + stat anchor OFF + CARN forward noiser
# (carn_recurse=true; flag block copied from the certified smoke_fnsync_on).
...
export PORTOFF=${PORTOFF:-9980}
export RUNSTAMP=${RUNSTAMP:-$(date +%H%M%S)}
export DARM=ganv2f_all_cycle
