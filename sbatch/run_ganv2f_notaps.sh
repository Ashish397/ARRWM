#!/bin/bash
# ganv2f_notaps — fix-validation wave 2026-08-23. Base = run_ganfix_poolrich_v2.sh
# (poolrich + dmd_loss_start_step=0 + fixed-t0 disc, researcher-approved).
# Leave-one-out: ALL minus early taps (default blocks 6,12,18,24,29).
