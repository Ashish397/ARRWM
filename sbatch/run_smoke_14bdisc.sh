#!/bin/bash
# smoke_14bdisc — 60-step 2-node smoke of the WP-14B prefix backbone:
# LADD disc projected on Wan2.1-T2V-14B blocks [0,2,4,8] (prefix load).
# Base = ganv2f_all_noanchor (all fixes, stat anchor off). Validates load,
# memory, 5120-dim disc forward. No chained eval.
set -euo pipefail
