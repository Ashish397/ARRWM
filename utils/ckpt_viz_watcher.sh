...
ARMS="run3_flip2_roll run3_flip2_rolled run3_flip2_rollkl run3_flip2_rollrep run3_flip2_rollmsec run3_flip2_rollawssmoke run3_flip2_rolledsmoke run3_flip2_rollrepsmoke"
