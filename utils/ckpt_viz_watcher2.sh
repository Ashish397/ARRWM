...
ARMS="run3_flip2_rollmse9 run3_flip2_rollkl9 run3_flip2_rollklaw run3_flip2_rollklvz run3_flip2_rollklrep2 run3_flip2_rollklrep2smoke run3_flip2_rollawssmoke run3_flip2_rolledsmoke run3_flip2_rollmsec"
