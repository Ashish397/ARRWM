...
def main() -> None:
    ...
    p.add_argument("--output_root", default="/projects/u6ex/fbots/frodobots_encoded")
    p.add_argument("--overwrite", action="store_true")
    p.add_argument("--vae_path", default="/scratch/u6ex/as1748.u6ex/frodobots/Wan2.1-T2V-1.3B/Wan2.1_VAE.pth")
